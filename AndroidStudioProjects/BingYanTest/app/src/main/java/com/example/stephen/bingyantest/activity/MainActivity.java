...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.random_artical:
                if (currIndex!=0){
                    viewPager.setCurrentItem(0);
                }
                Intent randomIntent=new Intent(GET_RANDOM_ARTICAL);
                sendBroadcast(randomIntent);
                break;
            case R.id.favorites:
                Intent toFavoriteActivityIntent=new Intent(this,FavoritesActivity.class);
                startActivity(toFavoriteActivityIntent);
                break;
            case R.id.today_artical:
                if (currIndex!=0){
                    viewPager.setCurrentItem(0);
                }
                Intent todayIntent=new Intent(GET_TODAY_ARTICAL);
                sendBroadcast(todayIntent);
                break;
            default:break;
        }
        return true;
