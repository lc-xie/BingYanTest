...
import com.example.stephen.bingyantest.HttpUtil.GetVoice;
...
public class VoiceFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable final ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                mainHtml = HttpTool.getHtmlByHttpUrlConnection("http://voice.meiriyiwen.com/");
    ...
    public void loadNextPageVoices() {
        new Thread(new Runnable() {
            @Override
            public void run() {
                currentPageHtml = HttpTool.getHtmlByHttpUrlConnection(getNextPageUrl());
                if (currentPageHtml != "") {
                    voiceTagList.clear();
                    voiceNameList.clear();
                    voiceAuthorList.clear();
